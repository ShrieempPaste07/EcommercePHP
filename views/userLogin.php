    ...
    if (!empty($username) && !empty($password)) {
        ...
        if ($user_id) {
            ...
            if ($user['user_type'] === 'admin') {
                $errorMessage = "Please use admin login!";
            } else {
...
<div class="relative z-10">
    ...
    <div class="min-h-screen p-6 flex flex-col items-center justify-center">
        ...
        <form method="post" class="bg-white/80 backdrop-blur-sm p-4 rounded shadow w-[350px] text-black">
            ...
            <p class="text-center mt-4"><a href="./register.php" class="underline">Register as User</a></p>
            <p class="text-center mt-2"><a href="./adminLogin.php" class="underline">Login as Admin</a></p>
        </form>
    </div>
</div>
