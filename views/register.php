    ...
    <div class="relative z-10">
        ...
        <div class="min-h-screen p-6 flex flex-col items-center justify-center">
            ...
            <form method="post" action="login.php"
                ...
                <p class="text-center mt-4"><a href="./userLogin.php" class="text-gray underline hover:text-gray-600">Login as User</a></p>
                <p class="text-center mt-4"><a href="./userLogin.php" class="text-gray underline hover:text-gray-600">Login as Admin</a></p>
            </form>
        </div>
